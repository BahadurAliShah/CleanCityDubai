...
export function Hero() {
  return (
    <Container className="pt-20 pb-16 text-center lg:pt-32 bg-[url('/background-hero2.jpg')] bg-contain ">
      ...
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
          We believe in continuity and consistancy of performance standards at every touch point, while emphasizing <b>INTEGRITY</b>, <b>TRUST</b>, <b>RESPECT</b>, <b>TEAMWORK</b>, <b>PROFESSIONALISM</b>
